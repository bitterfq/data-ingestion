...
# Configuration
SPARK_PACKAGES="org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:1.5.2,org.apache.hadoop:hadoop-aws:3.3.4,com.amazonaws:aws-java-sdk-bundle:1.12.262"
...
spark-submit \
  ...
  --conf spark.sql.defaultCatalog=cdf \
